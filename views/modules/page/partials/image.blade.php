@php
    ...
    switch ($img->position) {
        case 'top':
            $img->class->push('img-responsive m-b-20');
            break;
        case 'bottom':
            $img->class->push('img-responsive m-t-20');
            break;
        case 'left':
            $img->class->push('pull-left m-r-20 m-b-20');
            break;
        case 'right':
        $img->class->push('pull-right m-l-20 m-b-20');
        break;
        default:
        $img->class->push('m-b-20');
    }
