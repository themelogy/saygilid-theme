                    ...
                    @if($slide->link_type != 'none')
                        <!-- LAYER NR. 4 -->
                            <a class="tp-caption rev-btn tp-resizeme rev-button"
                               ...
                               style="z-index: 8; white-space: nowrap; font-size: 14px; line-height: 14px; font-weight: 400; color: rgba(255,255,255,1); text-transform:uppercase;background-color:#4BADE9;border-color:rgba(0,0,0,1);border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">{{ $slide->link->title }} </a>
                    </li>
                    @endif
                @endforeach
            </ul>
